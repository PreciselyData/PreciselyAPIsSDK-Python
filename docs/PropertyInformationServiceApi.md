...
------------- | ------------- | -------------
[**get_parcel_boundary_by_address**](PropertyInformationServiceApi.md#get_parcel_boundary_by_address) | **GET** /property/v1/parcelboundary/byaddress | Get Parcel Boundary By Address
[**get_parcel_boundary_by_location**](PropertyInformationServiceApi.md#get_parcel_boundary_by_location) | **GET** /property/v1/parcelboundary/bylocation | Get Parcel Boundary By Location
...
> ParcelBoundary get_parcel_boundary_by_address(address)
...
> ParcelBoundary get_parcel_boundary_by_location(longitude, latitude)
