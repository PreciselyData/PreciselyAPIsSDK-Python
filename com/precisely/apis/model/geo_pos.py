...
class GeoPos(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, crs, *args, **kwargs):  # noqa: E501
        """GeoPos - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, crs, *args, **kwargs):  # noqa: E501
        """GeoPos - a model defined in OpenAPI
