...
class PropertyInformationServiceApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_parcel_boundary_by_address_endpoint = _Endpoint(
            settings={
                'response_type': (ParcelBoundaryV2,),
                'auth': [
                    'oAuth2Password'
                ],
                'endpoint_path': '/property/v2/parcelboundary/byaddress',
        ...
        self.get_parcel_boundary_by_location_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/property/v2/parcelboundary/bylocation',
        ...
        self.get_parcel_boundary_by_precisely_id_endpoint = _Endpoint(
            settings={
                'response_type': (ParcelBoundaryV2,),
                'auth': [
                    'oAuth2Password'
                ],
                'endpoint_path': '/property/v2/parcelboundary/bypreciselyID',
                'operation_id': 'get_parcel_boundary_by_precisely_id',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_parcel_boundary_by_precisely_id(
        self,
        precisely_id,
        **kwargs
    ):
        """Get Parcel Boundary By PreciselyID  # noqa: E501

        Accepts PB key as input and returns property attributes for the matched address.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_parcel_boundary_by_precisely_id(precisely_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['precisely_id'] = \
            precisely_id
        return self.get_parcel_boundary_by_precisely_id_endpoint.call_with_http_info(**kwargs)
