...
class AddressAutocompleteEnterpriseServiceApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.list_locations_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/typeahead/v1/list/locations',
            ...
            root_map={
                ...
                'attribute_map': {
                    ...
                    'search_on_po_box': 'searchOnPOBox',
                },
                'location_map': {
                    'search_text': 'query',
        ...
        self.list_select_endpoint = _Endpoint(
            settings={
                'response_type': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),
                'auth': [
                    'oAuth2Password'
                ],
                'endpoint_path': '/typeahead/v1/list/select',
                'operation_id': 'list_select',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def list_locations(
        ...
        **kwargs
        ...
        >>> thread = api.list_locations(search_text, transaction_id, async_req=True)
        >>> result = thread.get()
    ...
    def list_select(
        ...
        **kwargs
        ...
        """list_select  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_select(selected_address, transaction_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_content_type'] = kwargs.get(
            '_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['selected_address'] = \
            selected_address
        kwargs['transaction_id'] = \
            transaction_id
        return self.list_select_endpoint.call_with_http_info(**kwargs)
