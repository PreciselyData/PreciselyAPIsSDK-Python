...
class RisksServiceApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_fire_history_v2_endpoint = _Endpoint(
            settings={
                'response_type': (FireHistoryV2,),
                'auth': [
                    'oAuth2Password'
                ],
                'endpoint_path': '/risks/v2/firehistory',
                'operation_id': 'get_fire_history_v2',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_fire_risk_v2_by_address_endpoint = _Endpoint(
            settings={
                'response_type': (FireRiskV2Response,),
                'auth': [
                    'oAuth2Password'
                ],
                'endpoint_path': '/risks/v2/fire/byaddress',
                'operation_id': 'get_fire_risk_v2_by_address',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_fire_risk_v2_by_address_batch_endpoint = _Endpoint(
            settings={
                'response_type': (FireRiskV2ResponseList,),
                'auth': [
                    'oAuth2Password'
                ],
                'endpoint_path': '/risks/v2/fire/byaddress',
                'operation_id': 'get_fire_risk_v2_by_address_batch',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.get_fire_risk_v2_by_location_endpoint = _Endpoint(
            settings={
                'response_type': (FireRiskV2Response,),
                'auth': [
                    'oAuth2Password'
                ],
                'endpoint_path': '/risks/v2/fire/bylocation',
                'operation_id': 'get_fire_risk_v2_by_location',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_fire_risk_v2_by_location_batch_endpoint = _Endpoint(
            settings={
                'response_type': (FireRiskV2ResponseList,),
                'auth': [
                    'oAuth2Password'
                ...
                'endpoint_path': '/risks/v2/fire/bylocation',
                'operation_id': 'get_fire_risk_v2_by_location_batch',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def get_fire_history_v2(
        ...
        **kwargs
        ...
        >>> thread = api.get_fire_history_v2(post_code, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['post_code'] = \
            post_code
        return self.get_fire_history_v2_endpoint.call_with_http_info(**kwargs)
    ...
    def get_fire_risk_v2_by_address(
        self,
        address,
        **kwargs
    ):
        ...
        >>> thread = api.get_fire_risk_v2_by_address(address, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['address'] = \
            address
        return self.get_fire_risk_v2_by_address_endpoint.call_with_http_info(**kwargs)

    def get_fire_risk_v2_by_address_batch(
        self,
        fire_risk_by_address_request,
        **kwargs
    ):
        ...
        >>> thread = api.get_fire_risk_v2_by_address_batch(fire_risk_by_address_request, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['fire_risk_by_address_request'] = \
            fire_risk_by_address_request
        return self.get_fire_risk_v2_by_address_batch_endpoint.call_with_http_info(**kwargs)

    def get_fire_risk_v2_by_location(
        self,
        longitude,
        latitude,
        **kwargs
        ...
        >>> thread = api.get_fire_risk_v2_by_location(longitude, latitude, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['latitude'] = \
            latitude
        return self.get_fire_risk_v2_by_location_endpoint.call_with_http_info(**kwargs)

    def get_fire_risk_v2_by_location_batch(
        self,
        fire_risk_by_location_request,
        **kwargs
    ):
        ...
        >>> thread = api.get_fire_risk_v2_by_location_batch(fire_risk_by_location_request, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['fire_risk_by_location_request'] = \
            fire_risk_by_location_request
        return self.get_fire_risk_v2_by_location_batch_endpoint.call_with_http_info(**kwargs)
