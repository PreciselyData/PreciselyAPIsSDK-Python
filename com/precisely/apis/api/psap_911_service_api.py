...
class PSAP911ServiceApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.search_by_fcc_id_endpoint = _Endpoint(
            settings={
                'response_type': (AHJPlusPSAPResponse,),
                'auth': [
                    'oAuth2Password'
                ],
                'endpoint_path': '/911/v1/ahj-psap/byfccid',
                'operation_id': 'search_by_fcc_id',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def search_by_fcc_id(
        self,
        fcc_id,
        **kwargs
    ):
        """AHJ & PSAP By Fccid  # noqa: E501

        Accepts fccid as input and Returns contact details for Authorities Having Jurisdiction (AHJ) on-behalf-of local Public Safety Answering Points (PSAP). 911/PSAP accepts a location coordinate and returns PSAP contact data plus contact data for an AHJ to communicate directly with a PSAP. Details include agency name, phone number, city name, coverage, contact person's details, site details and mailing addresses for EMS, Fire, and Police PSAP contacts.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.search_by_fcc_id(fcc_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['fcc_id'] = \
            fcc_id
        return self.search_by_fcc_id_endpoint.call_with_http_info(**kwargs)
